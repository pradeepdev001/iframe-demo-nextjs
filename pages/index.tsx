...
export default function Modal() {
  ...
  const [urlState, setUrlState] = useState('sample');
  ...
  function handleIframe() {
    try {
      ...
      const anchors =
        iframeItem?.contentWindow?.document?.getElementsByTagName('a');
    } catch (error) {
  ...
  function getSampleID() {
    try {
      const iframeItem = gridIframe?.current;
      const data =
        iframeItem?.contentWindow?.document?.getElementById('sample_id');
      ...
      <main className="flex min-h-screen flex-col items-center  p-24">
        ...
        <div className="flex gap-10">
          <Radio
            ...
            label="https://www.canada.ca/en/immigration-refugees-citizenship/services/come-canada-tool.html"
          />
        </div>
              ...
              <div className="relative w-auto my-6 mx-auto max-w-3xl">
                ...
                <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                  ...
                  <div className="flex items-center justify-end p-6 border-t border-solid border-slate-200 rounded-b">
                    ...
                    <Button onClick={getSampleID}>Get Sample ID</Button>
                  </div>
                </div>
              </div>
            </div>
